...
class KVCacheConfigurator:
    ...
    # This runner's resolved kv-cache dtype string, back-filled by
    # ModelRunner.configure_kv_cache_dtype (construction happens before
    # resolution). The get_model().kv_cache_dtype bag leaf is RAW intent.
