...
class CommonKVManager(BaseKVManager):
    def __init__(
        ...
        self.kv_args = args
        # This engine's resolved kv-cache dtype (threaded from the model
        # runner via kv_args); falls back to the raw intent for transfer
        # backends that do not fill it.
        self.kv_cache_dtype_str = (
            getattr(args, "kv_cache_dtype_str", None) or server_args.kv_cache_dtype
        )
